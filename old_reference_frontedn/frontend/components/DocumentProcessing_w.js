/**
 * Document Processing Service - Wizard Integration
 * Adapted from ScanProcessor for grading wizard workflow
 * Uses gradingDataStore and wizard-specific events
 */
    ...
    async processDocument(uploadType) {
        ...
        while (retryCount <= maxRetries) {
            try {
                ...
                // Wizard Integration: Store processed data in gradingDataStore
                if (uploadType === 'rubric') {
                    gradingDataStore.setCurrentRubric(result);
                }
                ...
                // Emit wizard-specific completion event
                eventBus.emit('wizard:scan-processing-complete', {
